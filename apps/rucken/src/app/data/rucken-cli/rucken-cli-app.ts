...
npm run ng serve custom-app-nestjs`,
  ...
  images: [
    ...
    },
    {
      ...
      src:
        'assets/rucken-cli/generators/rucken-cli-applications-install-dependencies.png',
    },
    {
      description: 'Build NestJS applications',
      src:
        'assets/rucken-cli/generators/rucken-cli-applications-build-nestjs.png',
    },
    {
      description: 'Run migrations for NestJS applications',
      src:
        'assets/rucken-cli/generators/rucken-cli-applications-db-migrate-nestjs.png',
    },
    {
    ...
    },
    {
      ...
      src:
        'assets/rucken-cli/generators/rucken-cli-applications-build-ionic.png',
    },
    {
      description: 'Build Android Ionic applications',
      src:
        'assets/rucken-cli/generators/rucken-cli-applications-build-android-ionic.png',
    },
    {
      description: 'Serve NestJS application',
      src:
        'assets/rucken-cli/generators/rucken-cli-applications-serve-nestjs.png',
    },
    {
    ...
    },
    {
      ...
      src:
        'assets/rucken-cli/generators/rucken-cli-applications-serve-ionic.png',
    },
    {
    ...
    },
    {
      ...
      src:
        'assets/rucken-cli/generators/rucken-cli-applications-view-ionic.png',
    },
  ],
  outputs: [
    {
      ...
      url:
        'https://github.com/rucken/cli/tree/generators-outputs/generators/apps/custom-app-nestjs',
    },
    {
      title: 'Web application',
      buttonClass: 'btn-bootstrap',
      url:
        'https://github.com/rucken/cli/tree/generators-outputs/generators/apps/custom-app',
    },
    {
      title: 'Ionic application',
      buttonClass: 'btn-ionic',
      url:
        'https://github.com/rucken/cli/tree/generators-outputs/generators/apps/custom-app-ionic',
    },
  ],
  sources: [
    {
      url:
        'https://github.com/rucken/cli/blob/develop/src/commands/generator-application.ts',
    },
  ],
  packages: [
    {
      url:
        'https://www.npmjs.com/package/@rucken/cli#rucken-generator-application-name',
    },
  ],
});
