...
npx @rucken/cli config --mode=dev`,
    ...
    outputs: [
      {
        url:
          'https://github.com/rucken/cli/blob/generators-outputs/generators/angular.json#L41',
      },
    ],
    sources: [
      {
        url:
          'https://github.com/rucken/cli/blob/develop/src/commands/config.ts',
      },
    ],
    packages: [
      {
  ...
  new ModuleModel({
    ...
    outputs: [
      {
        url:
          'https://github.com/rucken/cli/blob/generators-outputs/generators/libs/custom-org/custom-lib/src/index.ts',
      },
    ],
    sources: [
      {
        url:
          'https://github.com/rucken/cli/blob/develop/src/commands/make-ts-list.ts',
      },
    ],
    packages: [
      {
        url:
          'https://www.npmjs.com/package/@rucken/cli#rucken-make-ts-list-folder',
      },
    ],
  }),
  new ModuleModel({
    ...
    outputs: [
      {
        url:
          'https://github.com/rucken/cli/tree/generators-outputs/generators/libs/custom-org/custom-lib/src/i18n',
      },
    ],
    sources: [
      {
        url:
          'https://github.com/rucken/cli/blob/develop/src/commands/translate.ts',
      },
    ],
    packages: [
      {
        url:
          'https://www.npmjs.com/package/@rucken/cli#rucken-translate-folder',
      },
    ],
  }),
  new ModuleModel({
    ...
    outputs: [
      {
        url:
          'https://github.com/rucken/cli/blob/generators-outputs/generators/libs/custom-org/custom-lib/package.json',
      },
    ],
    sources: [
      {
        url:
          'https://github.com/rucken/cli/blob/develop/src/commands/version-updater.ts',
      },
    ],
    packages: [
      {
        url:
          'https://www.npmjs.com/package/@rucken/cli#rucken-version-updater-folder',
      },
    ],
  }),
  new ModuleModel({
...
npx @rucken/cli prepare --mode=dev`,
    ...
    sources: [
      {
        url:
          'https://github.com/rucken/cli/blob/develop/src/commands/prepare.ts',
      },
    ],
    packages: [
      {
