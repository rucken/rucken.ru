...
npm run ng serve custom-app-nestjs`,
  ...
  sources: [
    {
      url:
        'https://github.com/rucken/cli/blob/develop/src/commands/generator-entity-to-application.ts',
    },
  ],
  packages: [
    {
      url:
        'https://www.npmjs.com/package/@rucken/cli#rucken-generator-entity-to-application-name',
    },
  ],
});
