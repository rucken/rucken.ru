...
npm i`,
  ...
  images: [
    ...
    },
    {
      ...
      src:
        'assets/rucken-cli/generators/rucken-cli-workspace-install-dependencies.png',
    },
  ],
  outputs: [
    {
  ...
  sources: [
    {
      url:
        'https://github.com/rucken/cli/blob/develop/src/commands/generator-workspace.ts',
    },
  ],
  packages: [
    {
      url:
        'https://www.npmjs.com/package/@rucken/cli#rucken-generator-workspace-name',
    },
  ],
});
