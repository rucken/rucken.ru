  ...
  outputs: [
    {
      ...
      url:
        'https://github.com/rucken/cli/blob/generators-outputs/generators/apps/custom-app-nestjs/src/app/app.module.ts#L19',
    },
    {
      title: 'Link of Web library',
      buttonClass: 'btn-bootstrap',
      url:
        'https://github.com/rucken/cli/blob/generators-outputs/generators/apps/custom-app/src/app/app.module.ts#L70',
    },
    {
      title: 'Link of Ionic library',
      buttonClass: 'btn-ionic',
      url:
        'https://github.com/rucken/cli/blob/generators-outputs/generators/apps/custom-app-ionic/src/app/app.module.ts#L104',
    },
  ],
  sources: [
    {
      url:
        'https://github.com/rucken/cli/blob/develop/src/commands/generator-library-to-application.ts',
    },
  ],
  packages: [
    {
      url:
        'https://www.npmjs.com/package/@rucken/cli#rucken-generator-library-to-application-name',
    },
  ],
});
