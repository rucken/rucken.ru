...
export const RUCKEN_WEB_APPLICATION = new ModuleModel({
  ...
  images: [
    ...
    },
    {
      ...
      src:
        'assets/rucken-core/web/rucken-web-entities-users-create-select-group.png',
    },
    {
  ...
  features: [
    ...
    {
      description:
        'Class based form and in service validation with transformation for work with backend',
      links: [
        {
    ...
    {
      description:
        'Base components with logic for manage entities list or grids and modal or route for edit one entity',
      links: [
        {
          title: 'ngx-bind-io',
